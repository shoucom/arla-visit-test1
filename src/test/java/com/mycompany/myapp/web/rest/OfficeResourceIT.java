...
class OfficeResourceIT {
    ...
    void createOffice() throws Exception {
        ...
        assertThat(testOffice.getLanguage()).isEqualTo(DEFAULT_LANGUAGE);
    }
    ...
    void putExistingOffice() throws Exception {
        ...
        assertThat(testOffice.getLanguage()).isEqualTo(UPDATED_LANGUAGE);
    }
    ...
    void partialUpdateOfficeWithPatch() throws Exception {
        ...
        partialUpdatedOffice.phone(UPDATED_PHONE).language(UPDATED_LANGUAGE);
