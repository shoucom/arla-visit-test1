...
describe('Visit Management Update Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, RouterTestingModule.withRoutes([]), VisitUpdateComponent],
      providers: [
        FormBuilder,
        {
  ...
  describe('ngOnInit', () => {
    it('Should call Visitor query and add missing value', () => {
      ...
      const visitor: IVisitor = { id: 9425 };
      visit.visitor = visitor;

      const visitorCollection: IVisitor[] = [{ id: 13150 }];
    ...
    it('Should call Office query and add missing value', () => {
      const visit: IVisit = { id: 456 };
      const office: IOffice = { id: 28988 };
      visit.office = office;

      const officeCollection: IOffice[] = [{ id: 17367 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const visit: IVisit = { id: 456 };
      const host: IEmployee = { id: 3889 };
      visit.host = host;

      const employeeCollection: IEmployee[] = [{ id: 27052 }];
    ...
    it('Should update editForm', () => {
      const visit: IVisit = { id: 456 };
      const visitor: IVisitor = { id: 3018 };
      visit.visitor = visitor;
      const office: IOffice = { id: 5697 };
      visit.office = office;
      const host: IEmployee = { id: 12002 };
      visit.host = host;
